...
function About() {
    return (
        ...
        <div style={{ backgroundColor: MainLightColor }} className='w-full h-[auto]  flex flex-col justify-center items-center pb-22'>
            ...
            <div className='bg-[] w-full h-auto lg:h-[400px] mt-7 flex flex-col lg:flex-row'>
                ...
                <div className='w-full h-full  flex justify-center items-start flex-col px-8 py-6'>
